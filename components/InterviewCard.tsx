...
const InterviewCard = ({
  ...
  if (loading) {
    return (
      <div className="bg-dark-200 rounded-xl p-6 w-full">
  ...
  return (
    <div className="bg-dark-200 rounded-xl p-6 w-full">
      <div className="flex flex-col h-full">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-light-400">{normalizedType}</p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 text-light-400 text-sm mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {typeof techstack === 'string' ?
              techstack.split(',').map((tech, index) => (
                <span key={index} className="bg-primary-200/20 text-primary-200 px-2 py-1 rounded-full text-xs">
                  {tech.trim()}
                </span>
              )) :
